...
const SKILLS = {
  frontend: { icon: <Layout className="w-5 h-5" />, title: "Frontend", skills: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Framer Motion", "Vue.js"] },
  backend: { icon: <Server className="w-5 h-5" />, title: "Backend", skills: ["Node.js", "Python", "Go", "Express", "NestJS", "GraphQL"] },
...
const PROJECTS = [
  {
    title: "FinDash Pro",
    category: "Frontend",
    description: "A real-time financial analytics dashboard for enterprise clients processing 1M+ transactions daily.",
    longDescription: "FinDash Pro solves the problem of fragmented financial data. By aggregating streams from 5 different APIs, it provides a unified view for portfolio managers. Features include real-time socket updates, interactive D3.js charts, and automated PDF reporting.",
  ...
  },
  {
    title: "HealthAI Core",
    category: "Systems",
    description: "HIPAA-compliant telemedicine platform connecting patients with specialists via secure video.",
    longDescription: "Built with security as the primary constraint. HealthAI Core uses end-to-end encryption for video calls and stores patient data in an isolated, compliant database environment. Handled over 10,000 consults in the first month.",
  ...
  },
  {
    ...
    category: "Backend",
    description: "Headless e-commerce solution focusing on core web vitals and sub-second load times.",
    longDescription: "A custom headless Shopify implementation. We moved the frontend to Gatsby to achieve a 98/100 Lighthouse performance score, resulting in a 25% increase in conversion rates for the client.",
    tags: ["Shopify API", "Gatsby", "GraphQL", "Redis"],
  ...
  },
  {
    ...
    category: "Frontend",
    description: "A comprehensive component library used across 5 different products to ensure brand consistency.",
    longDescription: "Orbit reduced UI development time by 40%. It includes 50+ accessible components, automated regression testing, and comprehensive documentation generated automatically from TypeScript types.",
    tags: ["Storybook", "React", "Rollup", "Lerna"],
...
const STATS = [
  ...
  { label: "Coffee Consumed", value: 9000, suffix: "L" },
];
    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in-up">
        ...
        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
          I'm <span className="text-slate-900 dark:text-white font-semibold">Temporary</span>, a Full Stack Developer & UX Designer.
    ...
    <footer className="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 py-12 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="text-center md:text-left">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Temporary</h3>
        ...
        <div className="text-slate-400 text-xs">
          &copy; {new Date().getFullYear()} Temporary. All rights reserved.
        </div>
      </div>
    </footer>
  );
